  ...
  return (
    <Layout>
      ...
      <section className="py-16 bg-[#FEFAF1]">
        <div className="container mx-auto px-4 sm:px-8">
          <h2 className="text-blue-900 text-2xl sm:text-3xl font-semibold text-center mb-8">{t.about_values_title}</h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 sm:px-8">
          <h2 className="text-blue-900 text-2xl sm:text-3xl font-semibold text-center mb-8">{t.about_why_title}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
      ...
      <section className="py-16 bg-gray-200 text-blue-900 relative">
        ...
        <div className="container mx-auto px-4 sm:px-8 text-center relative z-10">
          ...
          <Link
            href="/contact"
            className="bg-blue-900 border-2 border-blue-900 text-white py-2 px-6 rounded-full font-semibold hover:bg-gray-200 hover:border-2 hover:border-yellow-500 hover:text-blue-900 transition duration-300"
          >
            {t.nav_contact}
          </Link>
        </div>
