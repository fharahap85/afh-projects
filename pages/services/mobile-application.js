...
export default function Services() {
  ...
  return (
    <Layout>
      <SEO title={t.nav_services_mobile} description={t.services_mobile_description} />
        ...
        <section className="bg-background">
          <div className="py-12 px-4 sm:px-6 md:py-20 md:px-8 max-w-2xl mx-auto">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              ...
              <h2 className="text-2xl md:text-3xl font-bold mt-2 mb-4">{t.services_mobile_why_title}</h2>
              <p className="text-muted leading-relaxed mb-6">{t.services_mobile_why_content}</p>
            </motion.div>

            <motion.ul initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="space-y-4 mb-16">
              {[t.services_mobile_reach, t.services_mobile_interaction, t.services_mobile_performance].map((title, i) => (
                <li key={i} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted mt-0.5">
                      {[t.services_mobile_reach_desc, t.services_mobile_interaction_desc, t.services_mobile_performance_desc][i]}
                    </p>
                  </div>
                </li>
              ))}
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              ...
              <h2 className="text-2xl md:text-3xl font-bold mt-2 mb-8">{t.services_mobile_process_title}</h2>
            </motion.div>

            <div className="space-y-4 mb-16">
              {[t.services_mobile_process_design, t.services_mobile_process_development, t.services_mobile_process_launch].map((title, i) => (
                <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
                  <div className="bg-card-bg border border-card-border rounded-xl p-5 hover:border-accent/40 transition-colors">
                    ...
                    <p className="text-sm text-muted mt-2 ml-11">
                      {[t.services_mobile_process_design_desc, t.services_mobile_process_development_desc, t.services_mobile_process_launch_desc][i]}
                    </p>
                  </div>
                </motion.div>
              ))}
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              <div className="bg-accent/5 border border-accent/20 rounded-xl p-8 text-center">
                <h2 className="text-xl font-bold mb-2">{t.services_mobile_cta_title}</h2>
                <p className="text-muted text-sm mb-6">{t.services_mobile_cta_desc}</p>
